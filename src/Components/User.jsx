            ...
            <div className="container">
                ...
                <div className="mx-auto col-5 border p-5 shadow rounded">
                    <form action="" onSubmit={handleSubmit}>
                        ...
                        <input type="text" className='form-control' placeholder='Enter your email ' name='email' value={input ? input.email : ""} onChange={handleChange} /><br />
                ...
                <table className='table table-hover mt-5 border '>
                    <thead>
                        <tr >
                            ...
                            <td className="col-3 text-center fw-bold fs-5 ">Email</td>
                    ...
                    <tbody>
                        {user && user.map(i => {
                            return <tr>
                                ...
                                <td className='col-3 text-center'>{i.email}</td>
